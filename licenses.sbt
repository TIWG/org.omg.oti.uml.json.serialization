...
val oti_uml_json_serialization_license =
...
headers := Map("scala" -> (HeaderPattern.cStyleBlockComment, CommentBlock.cStyle(oti_uml_json_serialization_license)))
...
licenseConfigurations := Set("compile", "provided", "test")
